...
fifa_func = imp.load_compiled('fifa_func', 'fifa_tools' + os.sep + 'scripts' + os.sep + 'fifa15_functions.pyc')
...
class fifa_rx3:
    ...
    def file_ident_func(self):
        ...
        return (
         name, endianstr, endian, ('Total File Size:', round(filesize / 1024, 2), 'KBs'), offsets, mesh_count)
    ...
    def write_offset_data_to_file(self, path):
        ...
        for i in range(len(self.offset_list)):
            ...
            if self.offset_list[i][0] == 582139446:
            ...
            elif self.offset_list[i][0] == 3263271920L:
                ...
                for j in range(len(self.object_list)):
                    self.data.write(struct.pack('<2I', 3566041216L, len(self.object_list[j].name) + 1))
            ...
            elif self.offset_list[i][0] == 3566041216L:
                ...
                id = self.offset_list[i][3]
                self.data.write(struct.pack('<4I', self.offset_list[i][2], 1, 4294967295L, 0))
                ...
                self.data.write(struct.pack('<2I', self.group_list[id][3], 4294967295L))
            ...
            elif self.offset_list[i][0] == 4034198449L:
                id = self.offset_list[i][3]
    ...
    def write_offsets(self, data_pass):
        ...
        if data_pass == 0:
            ...
            for i in range(object_count):
                self.offset_list.append([3263271920L, 0, 0, i])
            ...
            if scn.face_edit_head_flag:
                for i in range(object_count):
                    self.offset_list.append([3751472158L, 0, 0, i])

            for i in range(object_count):
                self.offset_list.append([3566041216L, 0, 0, i])
            ...
            if scn.stadium_export_flag:
                ...
                for i in range(collision_count):
                    self.offset_list.append([4034198449L, 0, 0, i])
